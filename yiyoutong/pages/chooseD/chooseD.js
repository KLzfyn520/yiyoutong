...
Page({
  ...
  data: {
    ...
    month:nowMonth,
    day:nowDay,
    isToday: '' + nowYear + nowMonth + nowDay,
  ...
  toChooseT: function (e) {
    wx.navigateTo({
      url: '/pages/chooseT/chooseT?begin=' + this.data.begin + '&end=' + this.data.end + '&type=' + this.data.itemId + '&time=' + this.data.year + '-' + this.data.month + '-' + this.data.day
    })
  },
  ...
  inputTyping: function (e) {
    ...
    for(var i = 0;i<trainStation.length;i++){
      if(trainStation[i].search(value) != -1){
        var resultItem = {
          name: trainStation[i],
          type: '车站'
        }
    ...
    for(var i = 0;i<airportStation.length;i++){
      if(airportStation[i].search(value) != -1){
        var resultItem = {
          name: airportStation[i],
          type: '机场'
        }
  ...
  dateInit: function (setYear,setMonth) {
    var initDate1 = this.data.initDate
    var initDate = [
      {
        year:'',
        month:'',
    ...
    let dayNums = getDays(year,month);               //获取目标月有多少天
    let num = 0;
    let obj = [];
    ...
    initDate[0].year = year
    initDate[0].month = month
    initDate[0].dayArr = dateArr
    initDate1.push(initDate[0])
    this.setData({
      initDate:initDate1
    })
  },
  ...
  onLoad: function (options) {
    isToday: '' + nowYear + nowMonth + nowDay
    this.dateInit(nowYear,nowMonth)
    this.nextMonth()
    this.nextMonth()
    this.nextMonth()
  },
